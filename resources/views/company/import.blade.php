    ...
    <div class="container-fluid">
        <div class="mb-4">
            <div class="d-flex align-items-center">
                ...
                <h3 class="fw-bold mb-0" style="color: #f97316;">Import Data Instansi</h3>
            </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="font-size: 12px; margin-left: 25px;">
                    <li class="breadcrumb-item"><a href="{{ route('companies.index') }}"
                            class="text-decoration-none text-muted">Data Instansi</a></li>
                    <li class="breadcrumb-item active fw-bold" aria-current="page" style="color: #000;">Import Data Instansi
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 15px;">
            <div class="card-body p-5">
                {{-- Pastikan route 'companies.import.store' sudah terdaftar di web.php --}}
                <form action="{{ route('companies.import.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text mt-2 text-muted" style="font-size: 12px;">
                            * Gunakan format .xlsx atau .csv sesuai template instansi yang disediakan.
                        </div>
                        @error('file')
