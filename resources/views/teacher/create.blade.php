...
@section('content')
    <div class="container-fluid">
        <div class="mb-4">
            <h3 class="fw-bold" style="color: #f97316;">Tambah Data Guru</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="font-size: 12px;">
                    <li class="breadcrumb-item"><a href="{{ route('teachers.index') }}" class="text-decoration-none">Data
                            Guru</a></li>
            ...
            <form action="{{ route('teachers.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name"
                        ...
                        placeholder="Masukkan Nama Guru" value="{{ old('name') }}" required>
                    @error('name')
